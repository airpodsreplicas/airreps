...
Sigue estos pasos para realizar un reinicio suave en tus réplicas de AirPods:
![Cómo hacer reinicio suave a tus AirPods](/airpodssoftreset.webp)
...
## **Corrección de Desbalance L/R (La Forma Fácil)**
Para ajustar el balance de volumen izquierda/derecha en un dispositivo iOS, ve a Configuración > Accesibilidad. En un dispositivo Android, sigue estos pasos:
- Abre la app de Configuración y selecciona Accesibilidad de la lista.
- En la pantalla de Accesibilidad, desplázate hasta la sección Audio y Texto en Pantalla.
- Usa el deslizador para ajustar el balance de volumen hasta que el audio suene calibrado.

## **No Puedo Conectar a macOS**
Para solucionar problemas de conectividad con AirPods, intenta los siguientes pasos:
- Olvida los AirPods de tu iPhone (Esto parece ser un problema con iCloud Connect).
- Intenta conectar los AirPods a tu Mac.

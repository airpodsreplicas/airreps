---
description: Mestre AirPods QC & LC. Find designfejl, verificer softwarefunktioner, og skel mellem ægte enheder og kopier.
---
...
5. **Software - Om-side**: Tilslut dine AirPods til en iPhone og gå til Indstillinger > Generelt > Om. Hvis der er en "AirPods"-sektion, når du scroller ned, tjek at serienummeret vist der matcher serienummeret på indersiden af AirPods-låget. Hvis der ikke er en AirPods-sektion, er dine AirPods sandsynligvis kopier. **Vigtigt:** Nogle nyere AirPods-kopier kan have en fungerende "Om"-side, hvilket gør dette tjek mindre pålideligt. I sådanne tilfælde kan du tjekke for tilstedeværelsen af Spatial Audio med hovedsporing, eller verificere at firmwareversionen matcher den seneste version udgivet af Apple.

6. **Software - Spatial Audio**: Ægte AirPods understøtter Spatial Audio med hovedsporing. Mens mange nuværende kopier også understøtter Spatial Audio, kan kvaliteten og nøjagtigheden af hovedsporing variere. Hvis Spatial Audio helt mangler, eller hovedsporingen ikke fungerer korrekt, kan det indikere en kopi af lavere kvalitet eller en falsk. Dog er dette tjek alene ikke definitivt, da nogle kopier har god Spatial Audio-implementering.
...
|--------------------|------------------------|-------------------------------------------------------------|
| **USA**            | USA                    | FCC ID, "Designed by Apple in California"                   |
| **Europa**         | EU-lande               | CE (Conformité Européenne), WEEE                            |
| **Asien**          | Kina                   | CCC (China Compulsory Certificate)                          |
|                    | Sydkorea               | KC (Korea Certification)                                    |
|                    | Japan                  | MIC (Ministry of Internal Affairs and Communications)       |
|                    | Indien                 | BIS (Bureau of Indian Standards)                            |
| **Oceanien**       | Australien, New Zealand| RCM (Regulatory Compliance Mark)                            |
| **Canada**         | Canada                 | IC (Industry Canada)                                        |
| **Mellemøsten**    | Saudi-Arabien          | SASO (Saudi Standards, Metrology and Quality Organization)  |
|                    | UAE                    | ESMA (Emirates Authority for Standardization and Metrology) |
| **Latinamerika**   | Brasilien              | Anatel (National Telecommunications Agency)                 |

---
description: "Как внести вклад в проект AirReps. Форкните репозиторий, настройте окружение, внесите изменения и отправьте pull request."
---
...
1. Если вы выбрали Вариант 1 в разделе [Настройка среды разработки](#option-1-recommended), убедитесь, что страницы будут правильно собраны, выполнив следующую команду:

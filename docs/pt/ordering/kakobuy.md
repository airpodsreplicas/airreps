...
::: info
[KakoBuy](https://airreps.link/kakobuy) é um agente de compras — eles compram produtos a vendedores chineses em seu nome, inspecionam-nos e enviam-nos internacionalmente. Isto é especialmente útil se quiser **combinar o envio com outros itens da China**, ou se **não puder comprar diretamente** no site do vendedor.
:::

## Por que usar um agente?

- **Fotos de QC** — O KakoBuy fotografa os seus itens antes do envio para que possa verificar a qualidade
- **Sem KYC** — Pague com cartão de crédito/débito sem verificação de identidade
- **Combinar envios** — Agrupe vários itens num só pacote para poupar nos custos de envio

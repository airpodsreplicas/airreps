...
Os sensores intra-auriculares nas réplicas pausam a música quase instantaneamente (atraso de cerca de 1 segundo*) quando removidos dos ouvidos. O som de "bipe" ao inserir os AirPods corresponde de perto ao som original da Apple na maioria dos modelos atuais.

## Controles de Toque e Pressão (Force Touch)

Os controles de toque ou controles Force Touch nas réplicas são funcionais, mas podem exigir algum tempo para se acostumar. Para réplicas de 2ª geração, é necessário um toque firme, não um toque suave como nos AirPods originais. Para modelos Pro, apenas um leve empurrão ou aperto é necessário, não um toque.
:::info **Curiosidade**
As réplicas de AirPods Pro 2 (V5.3TB e mais recentes) apresentam uma configuração de sensor de pressão que corresponde de perto aos originais, proporcionando a mesma experiência a um custo muito menor.
:::

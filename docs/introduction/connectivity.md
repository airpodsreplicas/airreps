---
title: "AirPods Replica Connectivity"
description: "Connectivity details: iOS popup, macOS issues, range, latency, and multi-device support."
---
...
::: tip
Multi-device connectivity via **iCloud Connect** (seamless Apple ID device syncing) is exclusive to Huilian-based models: AirPods Pro 2 V5.3 Huilian and V5.4, AirPods Pro 3 V6 Huilian, Pro 3 V7, and AirPods 4 V2 Huilian. Other advanced chipsets (such as Airoha 1562AE/1571AM) support standard **Bluetooth Multipoint** across 2–3 devices, allowing multi-device switching without Apple ID integration.
:::

## Initial Connectivity with iOS Devices

In some cases, AirPods replicas may not connect to iOS devices initially. However, a fix often exists for this issue. See [Common Issues](/troubleshooting/other-common-bugs) for reset procedures, or the [iCloud compatibility fix](/troubleshooting/AirReps-Incompatibility-with-iCloud) if the issue is related to macOS pairing.

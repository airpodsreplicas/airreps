...
Czujniki w uchu w klonach wstrzymują muzykę niemal natychmiast (około 1 sekundy opóźnienia*) po wyjęciu z uszu. Dźwięk "bip" przy wkładaniu AirPods ściśle odpowiada oryginalnemu dźwiękowi Apple na większości obecnych modeli.

## Sterowanie Dotykowe i Force Touch

Sterowanie dotykowe lub Force Touch na klonach działa, ale może wymagać trochę przyzwyczajenia. Dla klonów 2. generacji wymagane jest mocne naciśnięcie, a nie lekkie dotknięcie jak na oryginalnych AirPods. Dla modeli Pro należy użyć tylko lekkiego dotknięcia lub ściśnięcia, nie przeciągnięcia.
:::info **Ciekawostka**
Klony AirPods Pro 2 (V5.3TB i nowsze) mają konfigurację czujnika siły, która ściśle odpowiada oryginałom, zapewniając takie samo doświadczenie za znacznie niższą cenę.
:::
## Jakość Mikrofonu

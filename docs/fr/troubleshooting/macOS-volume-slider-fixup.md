...
:::warning
Ce guide est destiné à ceux qui ont des Macs basés sur Intel (i3, i5, i7 ; pas les puces de la série M). Si votre Mac Apple Silicon (puce série M) ne lit pas l'audio avec vos AirReps actuels, consultez la section [Bugs courants](/fr/troubleshooting/other-common-bugs).
:::
...
<video src="/volume_fix/change-audio-device.webm" poster="/volume_fix/change-audio-device-poster.webp" width="500" height="558" autoplay loop muted playsinline aria-label="choisir périphérique audio"></video>

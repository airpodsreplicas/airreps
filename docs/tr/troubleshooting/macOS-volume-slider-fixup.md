...
:::warning
Bu rehber Intel tabanlı Mac'lere (i3, i5, i7; M serisi çip değil) sahip olanlar içindir. Apple Silicon (M serisi çip) Mac'in mevcut AirReps'inle ses çalmıyorsa [Yaygın Hatalar](/troubleshooting/other-common-bugs) bölümüne göz at.
:::

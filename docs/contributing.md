---
description: "How to contribute to the AirReps project. Fork the repo, set up your environment, make changes, and submit a pull request."
---
...
9. Open the project in an Integrated Development Environment (IDE) of your choice. We recommend [Visual Studio Code](https://code.visualstudio.com/), a feature-rich, free IDE. You can also use AI-powered IDEs like [Cursor](https://cursor.com/), which can make contributing much easier with code suggestions and documentation.

...
- If a heading ends with an explicit anchor like "{#payment-methods}", keep that anchor suffix EXACTLY as written (untranslated) after the translated heading text. It pins the URL fragment that other pages link to.
